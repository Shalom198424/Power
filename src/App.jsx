...
const PAD_CONFIG = [
  ...
  { id: '5', keyLabel: '5', code: 'Numpad5', url: '/sounds/5.mp3', name: 'FIESTA' },
  { id: '6', keyLabel: '6', code: 'Numpad6', url: '/sounds/6.mp3', name: 'FUERA' },
  { id: '-', keyLabel: '-', code: 'NumpadSubtract', url: '/sounds/mision.mp3', name: 'MISION' },
  { id: '1', keyLabel: '1', code: 'Numpad1', url: '/sounds/1.mp3', name: 'MIAU' },
  { id: '2', keyLabel: '2', code: 'Numpad2', url: '/sounds/2.mp3', name: 'OVNI' },
  { id: '3', keyLabel: '3', code: 'Numpad3', url: '/sounds/3.mp3', name: 'FRASE' },
  { id: '+', keyLabel: '+', code: 'NumpadAdd', url: '/sounds/aplausos.mp3', name: 'DERECHO' },
  { id: '0', keyLabel: '0', code: 'Numpad0', url: '/sounds/0.mp3', name: 'CLASES' },
  { id: 'slash', keyLabel: '/', code: 'Slash', url: '/sounds/grillo.mp3', name: 'GRILLO' },
  { id: 'hash', keyLabel: '#', code: 'Digit3', url: '/sounds/pato.mp3', name: 'PATO' }, // Maps mapped natively to divide
  { id: 'equal', keyLabel: '=', code: 'Equal', url: '/sounds/terror.MP3', name: 'TERROR' },
  { id: 'dollar', keyLabel: '$', code: 'Digit4', url: '/sounds/trompe.mp3', name: 'TROMPETA' },
];
